...
class SendEntryBatch extends Command
{
    protected $endpoint;
    ...
    protected $signature = 'ml:send-entry-batch
    ...
    public function handle()
    {
        ...
        $payloadData = $data->map(function ($item) {
            ...
            return [
                ...
                'rec_no'    => $item->rec_no,
                'label'     => $item->label,
                'timestamp' => Carbon::parse($item->locale_time)->toIso8601String(),
        ...
        $this->line(json_encode(['data' => $payloadData], JSON_PRETTY_PRINT));
