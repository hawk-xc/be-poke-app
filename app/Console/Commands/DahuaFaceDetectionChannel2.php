...
class DahuaFaceDetectionChannel2 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'dahua:face-detection-channel2 {start?} {end?}';
     ...
     * @var string
     */
    protected $description = 'Fetch Facedetection data on channel 2';
