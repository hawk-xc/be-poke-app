...
class DahuaFaceDetectionChannel3 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'dahua:face-detection-channel3 {start?} {end?}';
     ...
     * @var string
     */
    protected $description = 'Fetch Facedetection data on channel 3';

    protected int $channel = 3;
